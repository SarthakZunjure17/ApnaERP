...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('layout_config', postgresql.JSONB(as_text=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('dimensions_json', postgresql.JSONB(as_text=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('default_columns', postgresql.JSONB(as_text=True), nullable=False),
        sa.Column('default_filters', postgresql.JSONB(as_text=True), nullable=True),
        sa.Column('default_sorting', postgresql.JSONB(as_text=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('selected_columns', postgresql.JSONB(as_text=True), nullable=False),
        sa.Column('applied_filters', postgresql.JSONB(as_text=True), nullable=True),
        sa.Column('sorting_rules', postgresql.JSONB(as_text=True), nullable=True),
        sa.Column('grouping_rules', postgresql.JSONB(as_text=True), nullable=True),
        sa.Column('calculated_fields', postgresql.JSONB(as_text=True), nullable=True),
        sa.ForeignKeyConstraint(['owner_id'], ['users.id'], ondelete='SET NULL'),
    ...
    op.create_table(
        ...
        sa.Column('recipients', postgresql.JSONB(as_text=True), nullable=False),
        sa.Column('is_active', sa.Boolean(), server_default='true', nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('y_axis_fields', postgresql.JSONB(as_text=True), nullable=False),
        sa.Column('series_config', postgresql.JSONB(as_text=True), nullable=True),
        sa.Column('color_palette', postgresql.JSONB(as_text=True), nullable=True),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('code')
    )
    ...
    op.create_table(
        ...
        sa.Column('grid_position', postgresql.JSONB(as_text=True), nullable=False),
        sa.Column('settings_json', postgresql.JSONB(as_text=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('metrics_json', postgresql.JSONB(as_text=True), nullable=False),
        sa.Column('dimensions_json', postgresql.JSONB(as_text=True), nullable=True),
        sa.PrimaryKeyConstraint('id')
    )
