...
api_router.include_router(employee_documents.router, tags=["Employee Documents"])
api_router.include_router(positions.router, tags=["Job Positions"])
api_router.include_router(hr_configurations.router, tags=["HR Configurations"])
...
api_router.include_router(approval.router, tags=["Approval Workflows"])
api_router.include_router(salary_component.router, tags=["Salary Components"])
api_router.include_router(salary_structure.router, tags=["Salary Structures"])
api_router.include_router(employee_compensation.router, tags=["Employee Compensation"])
api_router.include_router(payroll_engine.router, tags=["Payroll Engine"])
api_router.include_router(payroll_run.router, prefix="/payroll-runs", tags=["Payroll Runs"])
api_router.include_router(payslip.router, tags=["Payslips"])
api_router.include_router(country.router, tags=["Countries"])
api_router.include_router(statutory_rule.router, tags=["Statutory Rules"])
api_router.include_router(employee_statutory_profile.router, tags=["Employee Statutory Profiles"])
api_router.include_router(payroll_adjustment.router, tags=["Payroll Adjustments"])
api_router.include_router(payroll_report.router, tags=["Payroll Reports"])
api_router.include_router(payroll_analytics.router, tags=["Payroll Analytics"])
api_router.include_router(payroll_closing.router, tags=["Payroll Closings"])
api_router.include_router(financial_integration.router, tags=["Financial Integration"])
api_router.include_router(bank_export.router, tags=["Bank Export Integration"])
...
api_router.include_router(unit_of_measure.router, prefix="/uoms", tags=["Units of Measure"])
...
api_router.include_router(storage_location.router, prefix="/locations", tags=["Storage Locations"])
...
api_router.include_router(purchase_requisitions.router, prefix="/purchase-requisitions", tags=["Purchase Requisitions"])
api_router.include_router(purchase_requisitions.router, prefix="/procurement/requisitions", tags=["Purchase Requisitions"])
api_router.include_router(rfqs.router, prefix="/rfqs", tags=["Requests For Quotations (RFQ)"])
api_router.include_router(rfqs.router, prefix="/procurement/rfqs", tags=["Requests For Quotations (RFQ)"])
api_router.include_router(supplier_quotations.router, prefix="/supplier-quotations", tags=["Supplier Quotations"])
